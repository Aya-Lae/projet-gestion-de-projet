...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = (error as any)?.response?.data?.message || (error as any)?.message || "Erreur lors de l'inscription";
      toast.error(msg);
    } finally {
      setLoading(false);
    }
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-sidebar items-center justify-center p-12">
        <div className="max-w-md text-center animate-fade-in">
          ...
          <p className="text-sidebar-muted text-lg">
            Rejoignez des milliers d'étudiants qui organisent leurs projets efficacement.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <Card className="w-full max-w-md border-0 shadow-lg animate-scale-in">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Commencez à gérer vos projets dès maintenant</CardDescription>
          </CardHeader>
          <CardContent>
